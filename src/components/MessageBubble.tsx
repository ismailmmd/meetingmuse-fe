...
export const MessageBubble: React.FC<MessageBubbleProps> = ({
  ...
  return (
    <div
      className={`flex ${isUser ? 'justify-end' : 'justify-start'} mb-6 fade-in`}
    >
      ...
      >
        {/* Message Content */}
        <div
          className={`text-sm leading-relaxed ${isUser ? 'text-white' : isProcessing ? 'text-blue-700' : 'text-gray-800'}`}
        >
          {isProcessing ? (
        ...
        {/* UI Elements (Buttons) */}
        {message.ui_elements?.buttons &&
          message.ui_elements.buttons.length > 0 &&
          onButtonClick && (
